...
export const supervisorLines: SupervisorLine[] = [
  {
    id: 'line-1',
    name: 'Line 1',
    currentProduct: 'Whole Milk 2L',
    status: 'RUNNING',
    oee: 91.3,
    throughputTarget: 520,
    throughputActual: 508,
  ...
  },
  {
    id: 'line-2',
    name: 'Line 2',
    currentProduct: 'Greek Yoghurt 500g',
    status: 'TRANSITION',
    oee: 78.5,
    throughputTarget: 360,
    throughputActual: 0,
  ...
  },
  {
    id: 'line-3',
    name: 'Line 3',
    currentProduct: 'Premium Orange Juice 1L',
    status: 'RUNNING',
    oee: 87.2,
  ...
  },
  {
    id: 'line-5',
    name: 'Line 5',
    currentProduct: 'Apple & Mango Blend 1L',
    status: 'DOWN',
    oee: 0,
    throughputTarget: 400,
    throughputActual: 0,
    throughputTrend: 'down',
    activeAlertCount: 2,
    runId: 'RUN-2026-0413',
...
export const labelValidation: LabelValidation = {
  status: 'PASSED',
};

export const cipVerification: CIPVerification = {
  status: 'VERIFIED',
  lastCycleDate: '2026-04-05 05:30',
  lastCycleType: 'Full CIP (Caustic + Acid)',
};

export const allergenCheck: AllergenCheck = {
  riskLevel: 'LOW',
  cleanDownRequired: false,
  cleanDownStatus: 'NOT-REQUIRED',
};
